...
/** Emit the workspace-level `_runtime.ts` for `@teseor/vue`: matchMedia-backed
 *  `useActiveBreakpoint` composable, `Responsive<T>` alias, and the
 *  `responsiveDataAttrs` helper that each wrapper spreads onto its root. */
