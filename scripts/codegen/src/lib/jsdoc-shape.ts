 ...
 * (with a non-empty `spec.repeating[]`) and atomic specs whose root is a
 * void HTML element get self-closing example tags because the component
 * renders only from the array prop / forbids children.
 */
